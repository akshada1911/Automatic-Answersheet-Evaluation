...
newtext=""
def store():
    workbook = xlsxwriter.Workbook('C:/Users/Admin/PycharmProjects/pythonProject/Questions/Answer.xlsx')
    worksheet = workbook.add_worksheet()
    worksheet.write('A1',newname)
    worksheet.write('A2',newtext)
    workbook.close()
...
class Test(tk.Frame):
    def __init__(self):
        ...
        tk.Button(new, text='  Submit  ', default='active', command=self.click_ok).grid(row=1, column=1, padx=13,
                                                                                        pady=21)
...
class App(tk.Frame):
    def __init__(self, master):
        ...
        choices = {'Communication', 'Electronics', 'Computer networks', 'Programming', 'EVS'}

        tkt.set('Communication')  # set the default option
        openmyfile('Communication')
        ...
        tk.Button(self, text='  Submit  ', default='active', command=self.click_ok).grid(row=3, column=1, padx=13,
                                                                                         pady=21, sticky=S)
